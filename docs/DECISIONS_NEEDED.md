...
Consolidated list of items that are **blocked on a human** (a decision, a credential, or an action only you can take). Maintained so an agent can resurface it at the start of a session. Last updated 2026-05-30.
...
| A2 | **Taxonomy rollout scope** | 22 repos lack taxonomy. Process which? *Rec: the real dicts (VCP, WIL, SKD, ACC, ApteES, BHS, BEN, CAE, SHS, CCS, STC, LRV, MCI, VEI); skip legacy/meta (COLOGNE, CORRECTIONS, temp_corrections_*); decide on tooling (csl-apidev, cologne-stardict, GreekInSanskrit).* | Roadmap Q7 / audit 2026-05-30 |
