...
`docs/` set stays easy to navigate. Nothing here is current guidance — each
...
These predate the 2026-06-04 boundary cleanup and describe source mining,
usage analytics, backlinks, citation tracking, and broad publication planning
that is no longer in scope. Kept as reference; superseded by the active doc.
...
Dictionary microstructure, macrostructure, headword conventions, the L0
convention cladogram, sense-alignment, and lexicographic-genealogy research
moved out of the GitHub/org observatory on 2026-06-03. The files below are
...
- [`LEXICOGRAPHY_ROADMAP.md`](https://github.com/sanskrit-lexicon/csl-observatory/blob/main/docs/archive/LEXICOGRAPHY_ROADMAP.md) — archived 25-09-2026 (H5358) into `docs/archive/`; [`METALEXICOGRAPHY_ROADMAP.md`](https://github.com/sanskrit-lexicon/csl-observatory/blob/main/docs/METALEXICOGRAPHY_ROADMAP.md) — sibling archive in flight: H5359, [PR #228](https://github.com/sanskrit-lexicon/csl-observatory/pull/228), awaits human merge
