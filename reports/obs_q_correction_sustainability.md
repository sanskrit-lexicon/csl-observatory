...
This complements the org-wide [`bus_factor.md`](https://github.com/sanskrit-lexicon/csl-observatory/blob/main/reports/bus_factor.md) (code contributions) by measuring **content corrections** to dictionary source text.
